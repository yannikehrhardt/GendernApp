...
//Uni Quizze
    ...
    let quiz1 = Quiz(type: "gap text" , topic: "Uni", question: "Was ist die korrekte ausführliche Doppelnennung für Studenten?", correctAnswer: ["Studenten und Studentinnen", "", ""], allAnswers: ["Studenten und Studentinnen", "Student/-innen", "StudentInnen"], furtherInformation: "Bei der ausführlichen Doppelnenneung werden gleichermaßen und explizit weibliche und männliche Personen angesprochen. Die ausführliche Doppelnennung erfolgt mit Hilfe unterschiedlicher Konjunktionen, die die beiden Fromen, die im Singular oder Plural stehen können, verbindet. Die Konjunktion kann auch durch einen Schrägstrich ersetzt werden.", createdBy: "")
    ...
    let quiz6 = Quiz(type: "gap text" , topic: "Uni", question: "Was ist die korrekte ausführliche Doppelnennung von Professoren?", correctAnswer: ["Professoren/Professorinnen", "", ""], allAnswers: ["Professoren/Professorinnen", "Professor*innen", "Professor[innen]"], furtherInformation: "Bei der ausführlichen Doppelnenneung werden gleichermaßen und explizit weibliche und männliche Personen angesprochen. Die ausführliche Doppelnennung erfolgt mit Hilfe unterschiedlicher Konjunktionen, die die beiden Fromen, die im Singular oder Plural stehen können, verbindet. Die Konjunktion kann auch durch einen Schrägstrich ersetzt werden.", createdBy: "")
