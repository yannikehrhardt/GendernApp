...
//Uni Quizze
    ...
    let quiz1 = Quiz(type: "gap text" , topic: "Uni", question: "Was ist die korrekte ausführliche Doppelnennung von Studenten?", correctAnswer: "Studenten und Studentinnen", allAnswers: ["Studenten und Studentinnen", "Student/-innen", "StudentInnen"], furtherInformation: "Die ausführliche Doppelnennung erfolgt mit Hilfe unterschiedlicher Konjunktionen odem der Verwendung eines Schrägstrichs. Die verkürzte Doppelnennung, auch Sparschreibung genannt, erfolgt durch Schrägstrich in Kombination mit Bindestrich, durch das Binnenmajuskel, durch den Genderstern, durch den Unterstrich oder durch die Klammern")
    ...
    let quiz6 = Quiz(type: "gap text" , topic: "Uni", question: "Was ist die korrekte ausführliche Doppelnennung von Professoren?", correctAnswer: "Professoren/Professorinnen", allAnswers: ["Professoren/Professorinnen", "Professor*innen", "Professor[innen]"], furtherInformation: "Die ausführliche Doppelnennung erfolgt mit Hilfe unterschiedlicher Konjunktionen odem der Verwendung eines Schrägstrichs. Die verkürzte Doppelnennung, auch Sparschreibung genannt, erfolgt durch Schrägstrich in Kombination mit Bindestrich, durch das Binnenmajuskel, durch den Genderstern, durch den Unterstrich oder durch die Klammern")
    ...
    let quiz9 = Quiz(type: "gap text" , topic: "Uni", question: "Welche Sparschreibung ist nicht üblich?", correctAnswer: "Wir wollen die Aufmerksamkeit des/-r Leser/-in wecken", allAnswers: ["Wir wollen die Aufmerksamkeit des/-r Leser/-in wecken", "Wir suchen einen Professor oder eine Professorin", "Wenden Sie sich bitte an den Doktorant/die Doktorantin"], furtherInformation: "Gibt es keine passende Möglichkeit der Ersetzung oder ist die Sparschreibung zu unübersichtlich, sollte man die ungekürzte Doppelnennung anwenden.")
    ...
    //Ersatzformen
    let quiz11 = Quiz(type: "gap text", topic: "Uni", question: "Was ist eine gute Ersatzform für Student?" , correctAnswer: "der/die Studierende", allAnswers: ["der/die Studierende", "die Studierenden", "der Student/die Studentin"], furtherInformation: "Die richtige Lösung ist in diesem Fall das substantivierte Partizip 1 Singular der/die Studierende.")
...
//AlltagsQuizze
    let quiz200 = Quiz(type: "gap text" , topic: "Alltag", question: "Welche ist die geeignetste Bezeichnung?", correctAnswer: "Ersatzperson", allAnswers: ["Ersatzperson", "Ersatzmann", "Erstazfrau"], furtherInformation: "In bestimmten Zusammenhängen ist es geeigneter geschlechtsindifferente Formen der Berufs-, Amts- und Funktionsbezeichung zu verwenden.")
