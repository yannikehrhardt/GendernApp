...
class Questions : ObservableObject{
    ...
    init() {
        quizze = [quiz1, quiz2, quiz3, quiz4, quiz5, quiz6, quiz7, quiz8, quiz9, quiz10, quiz11, quiz12, quiz13]
        UniQuizze = [quiz1, quiz2, quiz3, quiz4, quiz5, quiz6]
        SchuleQuizze = [quiz7, quiz8, quiz9, quiz10]
        AlltagQuizze = [quiz11, quiz12, quiz13]
    }
