...
// In dieser Klasse werden die hard gecodeden Quizze angelegt. Alle Quizze werden in einem Array namens quizze gespeichert. Weiterhin werden in dieser Klasse Funktionen implementiert, die auf die Quizze angewendet werden.
